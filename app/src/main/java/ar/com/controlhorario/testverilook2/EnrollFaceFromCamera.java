package ar.com.controlhorario.testverilook2;
...
import ar.com.controlhorario.testverilook2.sdk.BaseActivity;
import ar.com.controlhorario.testverilook2.sdk.BaseDialogFragment;
import ar.com.controlhorario.testverilook2.sdk.EnvironmentUtils;
import ar.com.controlhorario.testverilook2.sdk.LicensingManager;
import ar.com.controlhorario.testverilook2.sdk.LicensingStateResult;


public class EnrollFaceFromCamera extends BaseActivity implements LicensingManager.LicensingStateCallback {
    ...
    private CompletionHandler<NBiometricStatus, NSubject> completionHandler = new CompletionHandler<NBiometricStatus, NSubject>() {
        @Override
        public void completed(NBiometricStatus result, final NSubject subject) {
            if (result == NBiometricStatus.OK) {
                ...
                File outputFile = new File(TUTORIALS_OUTPUT_DATA_DIR, "face-image-from-camera.jpg");
                try {
                ...
                outputFile = new File(TUTORIALS_OUTPUT_DATA_DIR, "nltemplate-from-camera.dat");
                try {
